#Tugas Besar Praktikum Algoritma dan Struktur Data
#Bintang Abelian Mahardika W    H1A020070
#Nadira Nazwa Azzahra           H1A020072
#Muhammad Roihan Nur Izzuddin   H1A020076
#Fazel Abdilah Fakih            H1A020078
#Daniel Muhammad Ihsan          H1A020086
...
class ProcessImage:
    def DetectObject(self):
        ...
        while(vid.isOpened()):
            ...
            if(rc==True):
                ...
                predictedCoords=kObj.Estimate(ballX, ballY)
    ...
    def DetectBall(self, frame):
        #Set threshold to filter onlt green only & Filter it
